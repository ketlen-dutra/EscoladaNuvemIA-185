...
unidade_inicial = (input("Informe a unidade de demperatura: ")).upper()
unidade_final = (input("Informe a unidade para qual deseja converter: ")).upper()

if unidade_inicial == unidade_final:
    conversao = temperatura_inicial
